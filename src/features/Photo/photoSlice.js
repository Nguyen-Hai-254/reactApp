    ...
    reducers: {
        addPhoto: (state, action) => {
            const newPhoto = {
                ...
                categoryId: action.payload.option,
        ...
        editPhoto: (state, action) => {
            const findPhotoIndex = state.findIndex(photo => photo.id === action.payload.id);
            state[findPhotoIndex].categoryId = action.payload.option;
            state[findPhotoIndex].title = action.payload.title;
            state[findPhotoIndex].photo = action.payload.img;
        }
    }
})
